...
final class StatusBarView: NSView {
    ...
    private func build() {
        ...
        NSLayoutConstraint.activate([
            ...
            selectionLabel.leadingAnchor.constraint(greaterThanOrEqualTo: countSuffix.trailingAnchor, constant: 12),
            selectionLabel.trailingAnchor.constraint(lessThanOrEqualTo: freshnessLabel.leadingAnchor, constant: -12),
        ])
...
private final class ClickToCopyLabel: NSTextField {
    ...
    override func updateTrackingAreas() {
        ...
        let ta = NSTrackingArea(rect: bounds, options: [.activeInActiveApp, .mouseEnteredAndExited], owner: self, userInfo: nil)
        addTrackingArea(ta)
        trackingArea = ta
    }
